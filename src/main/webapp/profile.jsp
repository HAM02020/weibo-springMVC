            ...
            <div class="card mb-3 mb-md-4">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3 mb-md-4 d-flex justify-content-between">
                        <div class="h3 mb-0">${user.screen_name}</div>
                    </div>
                    ...
                    <div class="table-responsive-xl">
                        <table class="table text-nowrap mb-0">
                            <thead>
                            <tr>
                                <th class="font-weight-semi-bold border-top-0 py-2">关注</th>
                                <th class="font-weight-semi-bold border-top-0 py-2">粉丝</th>
                                <th class="font-weight-semi-bold border-top-0 py-2">微博</th>
                            </tr>
                            </thead>
                            <tbody>
                            <tr>
                                ...
                                <td class="py-3">
                                    <span class="badge badge-pill badge-complex bg-semi-soft-warning text-white">
                                        <span class="badge badge-sm badge-warning rounded-circle mr-2">关注</span>
                                        <span>${user.friends_count}</span>
                                    </span>
                                </td>
                                <td class="py-3">
                                    <span class="badge badge-pill badge-complex bg-semi-soft-success text-white">
                                        <span class="badge badge-sm badge-success rounded-circle">粉丝</span>
                                        <span>${user.followers_count}</span>
                                    </span>
                                </td>
                                <td class="py-3">
                                    <span class="badge badge-pill badge-complex bg-semi-soft-secondary text-white">
                                        <span class="badge badge-sm badge-secondary rounded-circle mr-2">微博</span>
