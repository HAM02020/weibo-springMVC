           ...
           <%--      微博数据      --%>
                    ...
                    <div class="col-md-6 col-xl-4 mb-3 mb-md-4">
                        <div class="card mb-3 mb-md-4">
                            <div class="card-header d-flex align-items-center">
                                <div class="face"><img width="50" height="50" src="${status.user.profile_image_url}?KID=imgbed,tva&amp;Expires=1593776627&amp;ssig=v8ff09SP16" class="avatar-lg rounded-circle"></div>
                                <div class="position-relative ml-3 ml-md-4">
                                    <h5 class="font-weight-semi-bold mb-0">${status.user.screen_name}</h5>
                                    <a class="font-weight-light mb-0">${status.created_at}</a>
                                    <a class="font-weight-light ml-3">${status.source}</a>
                            ...
                            <div class="card-body">
                                ...
                                <p id="wb_text" class="m-1">${status.text}</p>
                                <c:choose>
                                    <c:when test="${status.retweeted_status==null}">

                                        <div class="container-flex2">
                                            <c:forEach var="img_url" items="${status.pic_urls.thumbnail_pic}">

                                                <c:if test="${status.pic_urls.thumbnail_pic.size()==1}">
                                                    <img src="${img_url}">
                                                </c:if>
                                                <c:if test="${status.pic_urls.thumbnail_pic.size()>1}">
                                                    <div class="block">
                                    ...
                                    <c:when test="${status.retweeted_status!=null}">
                                        <div class="m-0" style="background-color: #f2f2f2">
                                            <a href="" id="wb_retweeted_name" class="m-1">@${status.retweeted_status.user.screen_name}</a>
                                            <a id="wb_retweeted_text" class="m-1">${status.retweeted_status.text}</a>
                                            <div class="container-flex2">
                                                <c:forEach var="img_url2" items="${status.retweeted_status.pic_urls.thumbnail_pic}">

                                                    <c:if test="${status.retweeted_status.pic_urls.thumbnail_pic.size()==1}">
                                                        <img src="${img_url2}">
                                                    </c:if>
                                                    <c:if test="${status.retweeted_status.pic_urls.thumbnail_pic.size()>0}">
                                                        <div class="block">
                                                            <img src="${img_url2}" width="100%" height="100%">
                                                        </div>
                                                    </c:if>
                            ...
                            <footer class="card-footer border-top d-flex">
                                <div class="d-flex align-items-center">
                                    <button style="background-color:rgba(0,0,0,0); border: 0px">
                                        ...
                                        <a style="white-space:nowrap;">
                                            <c:if test="${status.attitudes_count!=0}">
                                ...
                                <div class="d-flex align-items-center ml-3 ml-md-4">
                                    <button style="background-color:rgba(0,0,0,0); border: 0px">
                                        ...
                                        <a style="white-space:nowrap;">
                                            <c:if test="${status.comments_count!=0}">
                                ...
                                <div class="d-flex align-items-center ml-3 ml-md-4">
                                    <button style="background-color:rgba(0,0,0,0); border: 0px">
                                        ...
                                        <a style="white-space:nowrap;">
                                            <c:if test="${status.reposts_count!=0}">
            ...
            <div class="mb-3 mb-md-4 d-flex justify-content-between">
                <div class="h3 mb-0">
                    ...
                    <a href="/status/timeline/nextpage?pageNum=${pageNum}" class="page-link" href="#!" aria-label="Previous">下一页 </a>
                </div>
            </div>
